...
NeptuneT.AntiTriggerSpam = {
        "lester:vendita",
        "fuel:pay",
    }

NeptuneT.BlacklistedParticles = { -- You can get particles from here : https://vespura.com/fivem/particle-list/
...
NeptuneT.BlacklistedVehicleList = { -- Just configure this table PROPERLY
...
NeptuneT.BlacklistedPedList = { -- Just configure this table PROPERLY
...
NeptuneT.BlacklistedObjectList = { -- Just configure this table PROPERLY
